...
import com.service.service.SubjectsLocalService;
...
/**
 * Provides the base implementation for the subjects local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.service.service.impl.SubjectsLocalServiceImpl}.
 * </p>
 *
 * @author Tofu
 * @see com.service.service.impl.SubjectsLocalServiceImpl
 * @see com.service.service.SubjectsLocalServiceUtil
 * @generated
 */
public abstract class SubjectsLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements SubjectsLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.service.service.SubjectsLocalServiceUtil} to access the subjects local service.
	 */
	...
	@Override
	public Subjects addSubjects(Subjects subjects) throws SystemException {
		subjects.setNew(true);

		return subjectsPersistence.update(subjects);
	}
	 ...
	 */
	@Override
	public Subjects createSubjects(long id) {
		return subjectsPersistence.create(id);
	}
	...
	public Subjects deleteSubjects(long id)
		...
		return subjectsPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Subjects deleteSubjects(Subjects subjects) throws SystemException {
		return subjectsPersistence.remove(subjects);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Subjects.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return subjectsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return subjectsPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return subjectsPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return subjectsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public Subjects fetchSubjects(long id) throws SystemException {
		return subjectsPersistence.fetchByPrimaryKey(id);
	}
	...
	public Subjects getSubjects(long id)
		throws PortalException, SystemException {
		return subjectsPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return subjectsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Subjects> getSubjectses(int start, int end)
		throws SystemException {
		return subjectsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSubjectsesCount() throws SystemException {
		return subjectsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Subjects updateSubjects(Subjects subjects) throws SystemException {
		return subjectsPersistence.update(subjects);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.service.model.Subjects",
			subjectsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.service.model.Subjects");
	}
	...
	private SubjectsLocalServiceClpInvoker _clpInvoker = new SubjectsLocalServiceClpInvoker();
}