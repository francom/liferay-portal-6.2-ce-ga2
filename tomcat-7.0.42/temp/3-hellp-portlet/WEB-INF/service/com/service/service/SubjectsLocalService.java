...
/**
 * Provides the local service interface for Subjects. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Tofu
 * @see SubjectsLocalServiceUtil
...
public interface SubjectsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SubjectsLocalServiceUtil} to access the subjects local service. Add custom service methods to {@link com.service.service.impl.SubjectsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
