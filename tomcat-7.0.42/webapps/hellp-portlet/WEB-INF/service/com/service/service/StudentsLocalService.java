...
/**
 * Provides the local service interface for Students. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Tofu
 * @see StudentsLocalServiceUtil
...
public interface StudentsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link StudentsLocalServiceUtil} to access the students local service. Add custom service methods to {@link com.service.service.impl.StudentsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
